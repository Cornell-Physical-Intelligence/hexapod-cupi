...
from tools.assets.prepare_mkii_usd import check_stage_units_and_scale, dependencies, mass_comparison, read_inertials, rigid_bodies, sha256

FRAME_ATOL = 2e-7
CLOSURE_POINT_ATOL = 2e-7
CLOSURE_AXIS_ATOL = 2e-6
from tools.assets.mkii_fourbar_kinematics import CONTRACT_NUMERIC_ATOL, CONTRACT_ANGLE_DIAGNOSTIC_ATOL, compare_kinematic_contract
...
def validate(urdf, pins, usd, contract_path=None, *, closure_variant=None):
    from tools.assets.prepare_mkii_fourbar_usd import mesh_sources, read_stl, check_closure_variant, REVOLUTE_CLOSURE, PLANAR_D6_CLOSURE, PHYSICAL_MIMIC_CLOSURE
...
def main():
    ...
    from tools.assets.prepare_mkii_fourbar_usd import CLOSURE_VARIANTS
