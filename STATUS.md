...
Last reviewed: 2026-09-05 20:08 UTC. **No physical-model PPO has started.** The first complete nominal motion validation passed, but its refined repeat failed torque convergence. The subsequent Kp30/Kd0.30 candidate completed matched 32-environment / 600-step standing checks at both solver settings: nominal settled peak 0.665623 N·m versus refined 1.925209 N·m. Both individual physical checks passed, but their 1.259585 N·m difference exceeds the unchanged 0.096260 N·m comparison bound. No full campaign is admitted from these short checks. Both exact containers were removed and frozen source `a3081dd` is unchanged. Existing traces show placement-associated standing noise, so the next bounded diagnostic will test a pure world-position translation before further controller changes. [Matched standing comparison](artifacts/mkii_fourbar_2026-09-05/pd030_standing_comparison/README.md) · [Prior refined failure](artifacts/mkii_fourbar_2026-09-05/campaign_006_ramped_targets/README.refined_stop.md) · [First full nominal pass](artifacts/mkii_fourbar_2026-09-05/campaign_006_ramped_targets/README.md).
