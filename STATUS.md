...
Last reviewed: 2026-09-06 11:40 UTC launch snapshot. **The coincident-origin candidate passed its full-body collision control pair and has started a fresh validation campaign; physical-model PPO has not started.** Supervisor PID **1845574** launched at **11:40:47.559716 UTC** in `/home/orionh/HEXAPOD_runs/mkii_coincident_layout_v1/campaign_001/fourbar-campaign-20260906T114047Z-73b4f841/campaign.json`. The live campaign reports `state=running`, the nominal phase active and `errors=[]`. It reused the verified 100-control startup probe, then requires full nominal and refined validation before 64-environment / 3-update scratch PPO and the separate 512-environment / 1,000-update resumed run. Read live campaign/progress files before claiming that a later phase has started.

The overlapping two-robot controls cover all 31 bodies per robot and 1,922 directed foreign-body queries, retaining shared-ground support. The filtered control passed; the original negative control timed out after 600 seconds without GPU execution/output, an infrastructure failure preserved separately. The negative retry under PID **1842070**, launched at **11:19:35 UTC**, completed successfully with every source body excited and none unexcited. This establishes the observed isolation/control response for the tested geometry, layout and sample window; it does not mean all 1,922 possible pairs were physically excited. The successful combined pair report is `/home/orionh/HEXAPOD_runs/mkii_coincident_layout_v1/combined_overlap_001/pair_report.json`, SHA256 `3d67408fac04bc2f1484018806a7c3ea40efb260b85107a721c3f754b9f10e34`. All collision-fixture training/hardware admission flags remain false.

The [exact motion-prefix replay](artifacts/mkii_fourbar_2026-09-06/prefix_replay_001/README.md) completed at **03:50:35 UTC**: all 32 environments finished 1,000 standing plus 1,500 individual-motion controls, with 40,000 physical substeps and force writes per environment. Runtime identity, ordered reset placements, both standing metric windows, all 15 individual response minima and the principal motion-failure peaks exactly reproduce campaign 008. Maximum C-pin separation is **0.213821 mm**, raw demand **85.207611 N m**, passive velocity residual **221.326508 rad/s**, and relative pin velocity **7.051414 m/s**. Applied torque remains within its envelope at **5.5 N m**. Support reaches zero and the LM/LR pushlever direction checks fail; there are no resets or non-foot contacts. The six detailed and 31 compact NPZ files remain hashed on Spark; local reports, analysis and the remote file inventory preserve their provenance. The first observed LF-femur velocity impulse precedes torque clipping; that event order does not yet establish a cause.

The opt-in `coincident_flat_origin_v1` layout places independent flat-ground environments at the same small world origin before scene construction. It adds exact native reset, sensor-row, collider-group and own-articulation mimic-reference checks while preserving robot geometry, actuator parameters, timing and physical acceptance bounds. The historical `grid_2m_v1` default is unchanged. Runtime source **ae4f38828181b33c9fc4fd2b8f9d68b03e6c31f1** has functional identity `8fb32bc3e39642338bfbcf37bcc3a7e58d1ab0b8c901174532234248644a93e9`; the separate **297-path** release manifest is `isaaclab/deploy/mkii_fourbar_v1_coincident_layout_pipeline.sha256` (SHA256 `7c15d6ce4e6f5c516a361d74d7f062ae78a075450a2e123f073f1b535d0d757d`). **926 CPU tests passed**. Artifact-only collision tools were added in `0ae060750ad1f5773171a8abd1c198647ed66fde` without changing that functional identity. This is a numerical-placement candidate, not a confirmed fix. The user removed the progress automation; its absence was confirmed and it has not been recreated. Work continues toward admitted PPO and actual policy playback video.

Under the user's explicit instruction to remove competing processes and continue toward a finished PPO tonight, the verified weather CPU batch/continuation workers, score watchers and corrdiff materializer were stopped. All targeted processes were absent by **03:14 UTC**; output files were preserved. Spark had **118 GiB available memory** and no CUDA workload after cleanup. Current successor guard **1845570** holds `/opt/wx/gpu.lock`, bounded until **21:40:47.521619 UTC**, at `/home/orionh/HEXAPOD_runs/mkii_coincident_layout_v1/priority_20260906T114047Z/`. It was renewed for the fresh candidate campaign; earlier reservations remain historical evidence. Prior guard 1711343 released when campaign 008 failed. The shared note records continued exclusive priority. Tonight is the requested completion target, not a promise that unresolved physics or a useful policy can meet it.

The latest matched standing comparison passed **32 environments × 600 control steps** at both 64/16 and 128/16 position/velocity iterations. Settled torque peaks are **0.759237 and 0.755706 N m**, a **0.003530 N m** difference against the unchanged 0.05 N m bound. Mean plate heights differ by **18.111 µm** against 1 mm, both retain at least five loaded feet, and all individual physical checks pass. Actual placements and runtime identity match exactly except position iterations. This resolves the observed large standing-torque divergence for this tested recipe; it does not establish complete motion, terrain or hardware qualification. Peak passive velocity residuals remain 0.693/0.714 rad/s and pin speeds 0.01271/0.01256 m/s, with low population RMS; these observational metrics remain under review during motion validation.

The prior **campaign 007** stopped during nominal validation when the shared file changed at 22:18 UTC. Its frozen supervisor treated any byte change as a yield request; the weather request proposed concurrency that neither launcher implemented. The last flushed sample was standing step 600/1000, with no nominal final report or recorded physical failure. Its owned container was removed and reservation 1667860 released at 22:19:23 UTC. The new release preserves source fd34f66's exact-placement and raw-demand convergence requirements. A fresh candidate campaign must pass complete nominal/refined checks before 64-environment / 3-update scratch PPO, checkpoint/inference verification and separate 512-environment / 1,000-update resumed PPO. The passing short standing comparison does not admit these stages.

The separate GPU collision-isolation defect is fixed and the live root-body-pair controls succeeded: filtered overlapping robots report zero pair contacts/force while both contact the ground; the unfiltered control reaches 340 native contact points per directional query/sample. This measured pair response complements the authored whole-environment group audit; it is not full-body, workspace or hardware qualification. The old and fixed spaced-world traces are byte-identical, so this defect does not explain the standing transient. [Matched 32-world standing comparison](artifacts/mkii_fourbar_2026-09-05/final_velocity16_standing_comparison/README.md) · [Position replay](artifacts/mkii_fourbar_2026-09-05/translation_diagnostics/batch_followup_analysis/README.md) · [One/four/sixteen comparison](artifacts/mkii_fourbar_2026-09-05/translation_diagnostics/final_velocity16_comparison/README.md) · [Live overlap evidence](artifacts/mkii_fourbar_2026-09-05/dynamics_trace_analysis/live_controls_attempt_002/README.md) · [First full nominal pass](artifacts/mkii_fourbar_2026-09-05/campaign_006_ramped_targets/README.md).
...
- The Spark project mirror `/home/orionh/HEXAPOD` is a bind-mounted directory, not a Git repository. Campaign 008 uses `/home/orionh/HEXAPOD_runs/mkii_coordination_control_v1/source`; earlier frozen sources remain separate. Each bounded run has its own source hashes, supervisor, report and logs. Inspect live state before every launch; weather was stopped only under the user's explicit priority instruction.
