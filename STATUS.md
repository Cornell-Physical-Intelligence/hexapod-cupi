...
Last reviewed: 2026-09-05 20:53 UTC. **No physical-model PPO has started.** The first full nominal motion validation passed; its refined repeat failed torque convergence. Lowering Kd to0.30 did not resolve the batch difference: matched32-env standing peaks were0.665623 versus1.925209 N m. Single robots at(0,0),(6,0) and(2,-2)m remain quiet (0.667–0.681 N m over0.8–4s), so distance alone is not an established cause. A frozen-source8-env trace is now comparing its row0 directly with the single robot at(2,-2). A separate confirmed Isaac Lab3 compatibility bug omitted GPU cross-environment collision filtering. Fix `d863663` explicitly authors/verifies all groups and fixes a foreign-container disappearance race; all885CPUtests pass. GPU overlap verification is being prepared; authored groups do not prove backend isolation. Motor/physical acceptance gates remain unchanged. [Translation evidence](artifacts/mkii_fourbar_2026-09-05/translation_diagnostics/README.md) · [SDK isolation finding](artifacts/mkii_fourbar_2026-09-05/dynamics_trace_analysis/sdk_collision_isolation/README.md) · [Matched standing comparison](artifacts/mkii_fourbar_2026-09-05/pd030_standing_comparison/README.md) · [First full nominal pass](artifacts/mkii_fourbar_2026-09-05/campaign_006_ramped_targets/README.md).
