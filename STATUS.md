...
Last reviewed: 2026-09-06 02:22 UTC. **Campaign 008 is running full nominal validation; physical-model PPO has not started.** Its fresh 1-environment × 100-control-step startup probe passed. The 32-environment nominal phase has reached standing step 200/1000; the driven sequence and refined comparison remain ahead. Campaign PID 1712641 runs from frozen source **1239159** at `/home/orionh/HEXAPOD_runs/mkii_coordination_control_v1/source`. Live state: `/home/orionh/HEXAPOD_runs/mkii_coordination_control_v1/campaigns/fourbar-campaign-20260906T021507Z-9d668815/campaign.json`.

The user explicitly granted full Spark takeover. The identified weather GPU queue was stopped gracefully with outputs preserved; by 02:08 UTC its parent and GPU processes were gone. Guard **1711343** holds `/opt/wx/gpu.lock`, bound to this campaign's terminal state with a maximum expiry of **12:06:50 UTC**. Hexapod has exclusive GPU admission; concurrency/MPS is not enabled. The new supervisor responds to explicit or invalid sharing controls while allowing ordinary status-note edits. A live prose-only update at 02:21 UTC was observed by the running supervisor without a pause, stop marker or container interruption. **906 CPU tests and GitHub CI passed.**
