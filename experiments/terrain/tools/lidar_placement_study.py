...
Score every mount in the shipped candidate list at the Stage2C stance::
    ...
    python3 experiments/terrain/tools/lidar_placement_study.py

Sweep an upright mast from flush to 300 mm::

    python3 experiments/terrain/tools/lidar_placement_study.py --sweep mast --sweep-range 0 0.30 0.02

Sweep forward pitch on a 60 mm mast::

    python3 experiments/terrain/tools/lidar_placement_study.py --sweep pitch --sweep-range 0 60 5
"""
