...
def load_geometry_helpers():
    ...
    import numpy as np
    from experiments.terrain.tools.terrain_fixture_checks import audit_usd, bind_fixture_material, collision_meshes, load_catalog, probe_locations, vertical_surface_heights
...
def main():
    ...
    parser.add_argument("--fixtures", help="Comma-separated fixture IDs; default all 30")
