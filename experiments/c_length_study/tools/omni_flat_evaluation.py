...
from experiments.c_length_study.tools.omni_flat_math import evaluation_scenarios, transition_sequence, scenario_gate, trajectory_command, integrate_body_twist
...
def evaluate_omni(env, runner, plan, output, checkpoint_sha):
    if "diagnostics" in plan["omni"]:
        from experiments.c_length_study.tools.omni_diagnostics import evaluate_diagnostics
...
def record_omni(env, runner, plan, output, checkpoint_sha):
    from experiments.c_length_study.tools.omni_path_demo import record_path_demo
