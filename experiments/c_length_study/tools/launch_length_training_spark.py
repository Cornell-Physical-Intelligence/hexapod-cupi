...
from experiments.c_length_study.tools.rank_length_study import summarize
...
def run_job(args, variant, mode, stance, admission=None, checkpoint=None, iterations=None):
    ...
    try:
        ...
        cli=["docker","compose","--env-file","docker/.env.base","-f","docker/docker-compose.yaml","--profile","base",
             ...
             "/workspace/length-study/experiments/c_length_study/tools/train_length_study.py","--headless","--device","cuda:0",
