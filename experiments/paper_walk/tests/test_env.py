...
import numpy as np
import torch
from experiments.paper_walk.env_config import EnvConfig, JOINT_NAMES, KD, verify_assets
from experiments.paper_walk.env import PaperWalkEnv, emitted_target, executed_action_feature, motor_force, _diagnostic_servo, inverse_rotate, rotate
...
class ResetTests(unittest.TestCase):
    def test_selected_reset_preserves_other_physics_and_history_rows(self):
        ...
        env = PaperWalkEnv.__new__(PaperWalkEnv)
        env.device = "cpu"; env.num_envs = 3
