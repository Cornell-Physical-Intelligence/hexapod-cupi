...
RUN=BASE/'native_standing32_003'; PAUSE=BASE/'forecast_pause_015'
UNIT='hexapod-canonical-native-standing32-003-20260910.service'
INV='6eac4972e2e64f9991955a1b7bb73afc'
SOURCE=BASE/'standing_source_005'; HOST=BASE/'standing_host_007'; GUARD=BASE/'standing32_guard_003'; ASSET=BASE/'asset_001'
...
PINS=[('source',SOURCE,'FREEZE_SHA256.json','c87f2d340c935cd947c7aed3f3dcd7c9a9965b6e19d6726546abb560b27ab131',109),
 ...
 ('guard',GUARD,'FREEZE_SHA256.json','1d74557aab401e921f6e69609883682d6d575432f723d9b7cd8e79878b860739',59),
...
def audit():
 ...
 if attempt('invocation_binding',lambda:require(re.fullmatch('[0-9a-f]{32}',INV)is not None,'Actual native standing32_003 invocation remains pending')or True)is None:return result
