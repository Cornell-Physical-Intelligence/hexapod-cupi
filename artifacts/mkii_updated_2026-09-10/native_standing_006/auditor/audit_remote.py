...
RUN=BASE/'native_standing_006'; PAUSE=BASE/'forecast_pause_014'
UNIT='hexapod-canonical-native-standing-006-20260910.service'
INV='64a373e301c24b70aa3790c18aca147c'
SOURCE=BASE/'standing_source_005'; HOST=BASE/'standing_host_007'; GUARD=BASE/'standing_guard_008'; ASSET=BASE/'asset_001'
...
PINS=[('source',SOURCE,'FREEZE_SHA256.json','c87f2d340c935cd947c7aed3f3dcd7c9a9965b6e19d6726546abb560b27ab131',109),
 ...
 ('guard',GUARD,'FREEZE_SHA256.json','75553e2d957aefded20704e15835f3a1512d0d182080243edf720d50613ed0a7',70),
...
def audit():
 ...
 if attempt('invocation_binding',lambda:require(re.fullmatch('[0-9a-f]{32}',INV)is not None,'Actual native6 invocation remains pending')or True)is None:return result
