...
RUN=BASE/'native_standing_001'; PAUSE=BASE/'forecast_pause_006'
UNIT='hexapod-canonical-native-standing-001-20260910.service'
INV='f3cd14c1078e47c891d97718643b22aa'
SOURCE=BASE/'standing_source_001'; HOST=BASE/'standing_host_001'; GUARD=BASE/'standing_guard_002'; ASSET=BASE/'asset_001'
...
PINS=[('source',SOURCE,'FREEZE_SHA256.json','f81f61d257cb92b65ad80f3b7d27c45497e66254092e244a32da02555b11e2a4',40),
 ('host',HOST,'FREEZE_SHA256.json','30235851f0dc95ce0c36ac3ec6912db144a7d3d6a6ab21c023d70d7cfefc2a33',18),
 ('guard',GUARD,'FREEZE_SHA256.json','0860dfaaa515d6256dd72fdcd2b537c1f747f23c6427c6c50fcabae4da856b1b',73),
