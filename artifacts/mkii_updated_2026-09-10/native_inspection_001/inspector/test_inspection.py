...
class Checks(unittest.TestCase):
    ...
    def test_sdf_paths_not_just_count(self):
        r={'count':153,'valid':True,'paths':[x['path']for x in self.usd['colliders']],'pending_cooking_tasks':0}
        ...
        r['paths']=[x['path']for x in self.usd['colliders']];r['pending_cooking_tasks']=1
        with self.assertRaises(ValueError):core.validate_sdf(r,self.usd)
