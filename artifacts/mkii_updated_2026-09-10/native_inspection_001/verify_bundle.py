...
for directory in ('inspector','host','guard','auditor','partner_review','final_review'):
...
assert report['audit_verified']and not report['inspection_completed']and report['terminal_outcome']=='authentic_terminal_failure'
print('PASS',len(actual),'payloads; authentic failed inspection, no physical admission')
