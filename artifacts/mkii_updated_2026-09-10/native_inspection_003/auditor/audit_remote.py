...
RUN=BASE/'native_inspection_003'; PAUSE=BASE/'forecast_pause_003'
UNIT='hexapod-canonical-native-inspection-003-20260910.service'
INV='ab32f02fccd1400da1e25ff3b8e525d7'
SOURCE=BASE/'inspection_source_003'; HOST=BASE/'inspection_host_003'; GUARD=BASE/'inspection_guard_003'; ASSET=BASE/'asset_001'
SUPERVISOR=Path('/home/orionh/HEXAPOD_runs/mock_length_study_20260909/reference_physics_source_009')
PINS=[('source',SOURCE,'FREEZE_SHA256.json','1d636f6b6909171e366be7b08b3590c0a65a8a9206e57b76792d3f4bcd166cd8',33),
 ('host',HOST,'FREEZE_SHA256.json','94ef24b181f4144f658a3814796f147859133ebaece0b3e5f3f9355d3bd5c2de',15),
 ('guard',GUARD,'FREEZE_SHA256.json','3c041150881bfcc2e1b7c15d709880b24b6fb92eef541f15573fb6acab9ab327',38),
