...
class AuditTests(unittest.TestCase):
 ...
 def test_completed_needs_native_postexit_receipt_and_zero_exit(self):
  receipt={'scope':'provisional_standing_only','standing_pass':True,'num_envs':1}
 ...
 def test_restore_exact_timer_and_launch_bindings(self):
  ...
  for bad in ({'timers':['a.timer','b.timer']},{'timers':['a.timer','a.timer']},{'restored_unix':float('nan')},{'scope':'exclusive_release'},{'persistent_reservation_release_attempted':True}):
