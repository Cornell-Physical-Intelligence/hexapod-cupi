...
pmap={p['id']:p for p in parts};w=fk(json.load(open(root/'cad_pose.json')));results=[]
...
Path('/tmp/hexapod-urdf-joint-validation-20260910/source_cad_screw_penetration.json').write_text(json.dumps(results,indent=2)+'\n')
