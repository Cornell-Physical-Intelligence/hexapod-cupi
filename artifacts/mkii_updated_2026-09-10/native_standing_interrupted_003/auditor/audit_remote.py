...
RUN=BASE/'native_standing_003'; PAUSE=BASE/'forecast_pause_009'
UNIT='hexapod-canonical-native-standing-003-20260910.service'
INV='ff270c50458f47e5940dd93c4b3aa845'
SOURCE=BASE/'standing_source_003'; HOST=BASE/'standing_host_003'; GUARD=BASE/'standing_guard_004'; ASSET=BASE/'asset_001'
...
PINS=[('source',SOURCE,'FREEZE_SHA256.json','e922ff1312b5106f957b384874ca5eb6ed4a9ed6566c0ef9a0602247a49670f0',87),
 ('host',HOST,'FREEZE_SHA256.json','968caeb48082ee0a72dea9acc1a6b7b93d2f9b14b9f4c2f05874070a03be1a95',28),
 ('guard',GUARD,'FREEZE_SHA256.json','5f13bfd6d23754051bd0520ca3a47d49d22aa467da8dcd2d56f50a87da6c2ea9',33),
