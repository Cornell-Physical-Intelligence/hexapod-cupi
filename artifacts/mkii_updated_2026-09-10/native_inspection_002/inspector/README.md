# Canonical model: native import inspection, Phase A successor002
...
```sh
PYTHONDONTWRITEBYTECODE=1 .venv/bin/python3 -m unittest discover -s tmp/updated_native_inspection_002 -p 'test_*.py' -v
python3 -S tmp/updated_native_inspection_002/verify_bundle.py
```
