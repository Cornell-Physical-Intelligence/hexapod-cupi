...
def main():
    ...
    omni.update(architecture="c_serial_omni_target_velocity_v1", history_frames=5,
        ...
        initial_exploration_std=.005, sampled_calibration_control_steps=1000,
    ...
    provenance = dict(corrective_scope="Candidate 003 fixes only the RSL early-checkpoint logger lifecycle; candidate002 physics/std/gates preserved",
        prior_candidate_manifest_sha256="53dc53c89984c5681a2ebe631754dfb6efe3b0fcd928865629ed8d55a2e9fbe8",
        base_code_commit=BASE_COMMIT, base_plan_sha256=BASE_PLAN_SHA,
