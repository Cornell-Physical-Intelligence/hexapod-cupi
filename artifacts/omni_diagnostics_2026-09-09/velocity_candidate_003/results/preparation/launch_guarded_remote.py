...
OUTPUT = BASE / 'omni_velocity_probe_003'
PAUSE = BASE / 'forecast_pause_021'
UNIT = 'hexapod-omni-velocity-probe-003-20260910.service'
...
''')
        ...
        subprocess.run(['systemd-run', '--user', '--unit=hexapod-forecast-restore-021', '--on-active=30m',
