...
source=base/'reference_physics_source_005';run=base/'reference_physics_005';pause=base/'forecast_pause_031'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-005-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
