...
source=base/'reference_directional_source_001';run=base/'reference_directional_001';pause=base/'forecast_pause_041'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-directional-001-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
