...
SOURCE = BASE / 'reference_rr_preload_source_001'
OUTPUT = BASE / 'reference_rr_preload_001'
PAUSE = BASE / 'forecast_pause_048'
UNIT = 'hexapod-rr-preload-001-20260910.service'
...
def main():
    ...
    check_source(SOURCE)
    if hashlib.sha256((SOURCE/'campaign_source_hashes.json').read_bytes()).hexdigest() != '9b71ad4e4be3e75ec34735725e0f815ac4ab0f4c40871150384658e2fdfc9268':
