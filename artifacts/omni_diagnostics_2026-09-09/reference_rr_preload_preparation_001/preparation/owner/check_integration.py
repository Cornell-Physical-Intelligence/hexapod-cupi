...
HERE=Path(__file__).resolve().parent;SOURCE=HERE/'source_rr_preload_001';sys.path.insert(0,str(SOURCE/'tools'))
...
r={'runtime':runtime,'source_manifest_sha256':host.digest(SOURCE/'campaign_source_hashes.json'),'source_files':931,'actual_directional002_old_admission_rejected':old_rejected,'failed_quiet_synthetic_receipt_rejected':quiet_rejected,'all_named_cases_preflight':cases,'synthetic_receipts_are_CPU_only':True,'physics_admitted':False}
