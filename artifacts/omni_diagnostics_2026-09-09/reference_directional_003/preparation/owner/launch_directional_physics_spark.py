#!/usr/bin/env python3
"""Fresh standing then two previously unmeasured named low-speed directional reference cases; no PPO."""
import argparse
import fcntl
import hashlib
import json
...
def command(source, output, name, phase):
    if phase != "standing" and phase not in CASES:
        raise ValueError("Only fresh standing and two previously unmeasured named directional cases exist")
