...
RUNTIME = ('caps.py', 'caps_ppo.py', 'gradient_diagnostics.py', 'curriculum.py', 'direct_config.py',
...
def patch_entry(text):
    ...
    text = one(text, 'AppLauncher.add_app_launcher_args(parser)', '''parser.add_argument("--direct-allocation", choices=("smoke", "pilot", "extended"))
