...
source=base/'reference_physics_source_003';run=base/'reference_physics_003';pause=base/'forecast_pause_029'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-003-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
