...
names=['direct_omni_train_smoke_003/campaign.json',*[f'direct_omni_train_smoke_003/jobs/{p}.json' for p in ['standing','train','final_constant','final_stop']],'forecast_pause_059/pause.json','forecast_pause_059/restored.json']
...
unit='hexapod-direct-omni-train-smoke-003-20260910.service';inv='0882531a12724963a64901721d87dc96'
