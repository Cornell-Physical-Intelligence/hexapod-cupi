...
Training completed 2 updates, 48 controls × 32 replicas (1,536 transitions). Wrapper time 3.55 s; 433 transitions/s. Strict reload reported True.
...
Next decision: Review every directional and quiet failure before separately dispatching one explicitly selected bounded allocation. Existing failures remain unqualified.
