...
source=base/'reference_physics_source_007';run=base/'reference_physics_007';pause=base/'forecast_pause_033'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-007-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
