...
class ActualMainOrderTests(unittest.TestCase):
 def execute(self,fail_at=None):
  ...
  with contextlib.ExitStack() as stack:
   ...
   stack.enter_context(patch.object(g.hashlib,'sha256',return_value=SimpleNamespace(hexdigest=lambda:'fdad0bb0126158988dc36ea38538b2f7804299cffb5ff29601ba597089672234')))
 ...
 def test_actual_order_fallback_before_timer_stop_two_checks_then_dispatch(self):
  ...
  self.assertEqual(dispatch[-4:],['--allocation','smoke','--branch','caps'])
