...
class RunnerTests(unittest.TestCase):
    def test_zero_mean_initialization_and_explicit_std(self):
        ...
        self.assertTrue(torch.allclose(r.alg.actor.distribution.std_param,torch.full((18,),.05)))
    ...
    def test_preflight_actual_c_asset_and_matched_admission(self):
        with TemporaryDirectory() as tmp:
            ...
            plan['omni']={'architecture':LINEAGE,'velocity_candidate':{'profile':'formal_004','max_acceleration_rad_s2':8.},'overrides':{'observation_noise_scale':1.,'target_filter_time_constant_s':0.}}
