...
SOURCE = BASE / 'omni_velocity_source_001'
OUTPUT = BASE / 'omni_velocity_probe_001'
PAUSE = BASE / 'forecast_pause_018'
UNIT = 'hexapod-omni-velocity-probe-001-20260910.service'
...
''')
        ...
        subprocess.run(['systemd-run', '--user', '--unit=hexapod-forecast-restore-018', '--on-active=30m',
