...
source=base/'reference_origin_source_002';run=base/'origin_rate_002';pause=base/'forecast_pause_038'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-origin-rate-002-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
