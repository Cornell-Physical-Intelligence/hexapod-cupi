"""Verify or reconstruct exact reference002 from immutable reference001 + delta.
...
PARENT='a13f1534f9f802871a2cacbc0be603eae2d80738905381da40691f7cd4beff7c'
TARGET='34390c6162f462baa4c531f1d5aff346ffbc98d4d0266a68ea797f5e5b992ee0'
...
def main():
    ...
    if sha(parent/'campaign_source_hashes.json')!=PARENT:raise ValueError('Wrong immutable source001')
    ...
    if set(overlay)!={'tools/canonical_stance_startup.py','tools/run_reference_physics.py','tools/screen_contract.py'}:
        raise ValueError('Only the reviewed startup delta is permitted')
    ...
    if virtual!=final:raise ValueError('Merged source does not equal frozen source002')
