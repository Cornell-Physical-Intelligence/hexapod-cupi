...
source=base/'reference_physics_source_002';run=base/'reference_physics_002';pause=base/'forecast_pause_028'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-002-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
