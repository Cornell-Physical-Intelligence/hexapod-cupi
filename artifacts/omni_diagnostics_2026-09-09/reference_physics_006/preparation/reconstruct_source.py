"""Verify or reconstruct exact reference006 from immutable reference005 + delta.
...
TARGET='90d7cf551ccf52f7cc2d224b81547c1bad0ad6191c2db56389bb2d54de0ff193'
...
def main():
    ...
    if sha(parent/'campaign_source_hashes.json')!=PARENT:raise ValueError('Wrong immutable source005')
    ...
    if set(overlay)!={'tools/solver_comparison.py','tools/reference_physics_env.py','tools/screen_contract.py'}:
    ...
    if virtual!=final:raise ValueError('Merged source does not equal frozen source006')
