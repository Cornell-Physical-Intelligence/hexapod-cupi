...
source=base/'reference_physics_source_006';run=base/'reference_physics_006';pause=base/'forecast_pause_032'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-006-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
