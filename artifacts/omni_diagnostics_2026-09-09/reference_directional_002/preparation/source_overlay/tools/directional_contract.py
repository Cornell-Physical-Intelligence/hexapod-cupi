"""Three previously unmeasured named low-speed directional reference cases; no wider policy admission."""
from pathlib import Path
from types import SimpleNamespace
import json,math
from screen_contract import preflight as standing_preflight,digest
CASES={'left_strafe':(0.,.005,0.),'left_turn':(0.,0.,.015),
       'forward_right_arc':(.005/math.sqrt(2),-.005/math.sqrt(2),-.01)}
PROTOCOL={'name':'reference_directional_discriminator002','parent_source009_manifest_sha256':'04942c62de1f557d8f117f648f990b6dac69443d61c546529d05a4e2a7f0e01e',
...
def preflight(args,source):
 if args.mode!='directional' or args.case not in CASES or args.num_envs!=1 or args.steps!=2400 or args.admission is None:
  raise ValueError('Only three previously unmeasured named1x2400 cases after exact fresh standing are allowed')
