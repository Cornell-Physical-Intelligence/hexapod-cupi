...
source=base/'reference_directional_source_002';run=base/'reference_directional_002';pause=base/'forecast_pause_044'
def sha(p):return hashlib.sha256(p.read_bytes()).hexdigest()
assert sha(source/'campaign_source_hashes.json')=='7c64602cae91478aebd4b03adcc79f56084db7529fd1c54c0439d061075a1c58'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-directional-002-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
