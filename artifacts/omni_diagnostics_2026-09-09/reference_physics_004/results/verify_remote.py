...
source=base/'reference_physics_source_004';run=base/'reference_physics_004';pause=base/'forecast_pause_030'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-004-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
