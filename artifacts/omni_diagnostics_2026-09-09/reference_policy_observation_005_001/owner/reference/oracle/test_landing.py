...
class ActualPrefix:
    def __init__(self):
        ...
        self.r=WaveContactReference(self.names,replace(WaveConfig(),lift_m=.005,horizontal_duration_fraction=1.))  # Historical5mm prefix/landing regression; current default7mm tested separately.
