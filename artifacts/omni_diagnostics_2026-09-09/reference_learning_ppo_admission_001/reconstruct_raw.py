"""Reconstruct and verify every original raw byte into a fresh external folder."""
...
def main():
 ...
 print('Reconstructed and SHA-verified all 74 original raw files without compression/reencoding:',out)
