"""One unqualified native003 direct-PPO progress recording; no training."""
...
ADAPTER_FREEZE='2f2b807a8c4e265dc25270bceb21734e6f97c72a873f407eccc654b9480af0a4'
ADAPTER=None
PARENT=None
...
def validate_result(output,identity):
 state=read(output/'state.json');video=read(output/'video.json');final=read(output/'final_integrity.json')
 ...
 if final.get('passed') is not True or final.get('provenance')!=state.get('recording_provenance'):raise ValueError('Final close/integrity receipt mismatch')
