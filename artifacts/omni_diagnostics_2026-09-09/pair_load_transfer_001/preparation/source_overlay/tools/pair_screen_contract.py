...
PAIR_PROTOCOL={
    'name':'middle_pair_load_transfer_physics_diagnostic001',
    'scope':'Separate proposed four-support diagnostic, not walking or Stage2 admission',
    'parent_source_manifest_sha256':'04942c62de1f557d8f117f648f990b6dac69443d61c546529d05a4e2a7f0e01e',
    ...
    'pair_legs':['lm','rm'],'required_supports':['lf','lr','rf','rr'],
...
def preflight(args,source):
    if args.mode!='pair' or args.num_envs!=1 or args.steps!=1300:
        raise ValueError('Only separately identified1x1300 middle-pair diagnostic is permitted')
    ...
    return {'standing_identity':identity,'pair_protocol':PAIR_PROTOCOL,
