...
source=base/'reference_pair_source_001';run=base/'pair_load_transfer_001';pause=base/'forecast_pause_040'
def sha(p):return hashlib.sha256(p.read_bytes()).hexdigest()
assert sha(source/'campaign_source_hashes.json')=='69a1a23304448d53f7681dfa87ab4fa652ad682ba0e45406e82187a66c4224f0'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-pair-load-transfer-001-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
