...
source=base/'reference_physics_source_008';run=base/'reference_physics_008';pause=base/'forecast_pause_034'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-008-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
