"""Verify or reconstruct exact reference009 from immutable reference008 + delta.
...
TARGET='04942c62de1f557d8f117f648f990b6dac69443d61c546529d05a4e2a7f0e01e'
...
def main():
    ...
    if sha(parent/'campaign_source_hashes.json')!=PARENT:raise ValueError('Wrong immutable source008')
    ...
    if set(overlay)!={'tools/solver_comparison.py','tools/wave_reference.py','tools/physics_substeps.py'}:
        raise ValueError('Only reviewed qualified-liftoff and angle-observer overlays are permitted')
    ...
    if virtual!=final:raise ValueError('Merged source does not equal frozen source009')
