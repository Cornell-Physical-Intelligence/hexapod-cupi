...
source=base/'reference_physics_source_009';run=base/'reference_physics_009';pause=base/'forecast_pause_035'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-reference-physics-009-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
