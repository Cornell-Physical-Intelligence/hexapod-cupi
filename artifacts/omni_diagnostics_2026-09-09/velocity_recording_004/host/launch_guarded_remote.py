...
OUTPUT = BASE / 'omni_velocity_recording_004'
PAUSE = BASE / 'forecast_pause_023'
UNIT = 'hexapod-omni-velocity-recording-004-20260910.service'
...
''')
        ...
        subprocess.run(['systemd-run', '--user', '--unit=hexapod-forecast-restore-023', '--on-active=20m',
