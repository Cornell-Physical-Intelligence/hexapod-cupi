...
source=base/'reference_origin_source_001';run=base/'origin_rate_001';pause=base/'forecast_pause_037'
...
unit=subprocess.check_output(['systemctl','--user','show','hexapod-origin-rate-001-20260910.service','-p','ActiveState','-p','SubState','-p','Result'],text=True)
