...
expected={'xy14_4_repeat':'020efad4c8dbe4483c11d46d7a82d7c571ad89d65b32c86c38ce9a659e5411a3'}
...
base=['/usr/bin/python3','-B',str(root/'guard/launch_guarded_diagnostic.py'),'--bindings',str(binding),'--bindings-sha256',expected[arm],'--guard-freeze-sha256','2f2c8ec8317414a6087c5196033f99b9e55981a873a5b6b9eeaee9a1c671e1ec','--placement','xy14_4','--output',str(output)]
