...
def main(argv=None):
    ...
    parser.add_argument("--eval-scope", choices=("diagnostic", "full"), default="diagnostic")
    ...
    try:
        ...
        if args.mode == "diagnostic":
            ...
            if args.mode in ("video", "evaluate"):
            ...
            if args.mode == "train":
                ...
                from .evaluate import evaluate_suite, run_diagnostic_trial
