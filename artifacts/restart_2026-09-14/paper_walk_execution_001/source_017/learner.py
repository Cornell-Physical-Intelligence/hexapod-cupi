...
AMP_WIDTH = 61
ACTION_WIDTH = 18
SCHEMA = "canonical_paper_walk_ppo_amp_v2"
...
class PPOLearner:
    ...
    def update(self, rollout):
        """Apply PPO/estimator losses with optional post-step analytic KL stopping.
        ...
        cap or constrain between-rollout normalization changes.
        ...
        self.last_metrics.update(ppo_batches=ppo_batches, discriminator_batches=discriminator_batches,
                                 ...
                                 stop_reason="target_kl_crossed" if stopped else None,
