"""Prepared, explicit CPU BC continuation contrast; no simulator or PPO steps.

The default CLI only validates the immutable protocol and inputs. Execution
requires --execute and a fresh output directory. This artifact is a proposed
helper pending source integration, not an imported production runtime.
"""
