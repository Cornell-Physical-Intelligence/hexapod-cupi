...
def audit(arm, update, output, attempt=1):
    assert 1 <= attempt < 100
    ...
    evaluate_pack = A/f'{arm}_evaluate_update{update:06d}_{attempt:03d}'
    ...
    result = {'schema': 'canonical_forward_checkpoint_audit_v1',
        ...
        'evaluation_pack': str(evaluate_pack.relative_to(ROOT)),
...
if __name__ == '__main__':
    ...
    audit(args.arm, args.update, args.output, args.attempt)
