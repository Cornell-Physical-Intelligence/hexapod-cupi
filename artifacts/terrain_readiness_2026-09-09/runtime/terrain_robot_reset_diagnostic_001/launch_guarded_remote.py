...
SOURCE = BASE / 'terrain_robot_reset_diagnostic_source_001'
OUTPUT = BASE / 'terrain_robot_reset_diagnostic_001'
...
''')
        ...
        subprocess.run(['systemd-run', '--user', '--unit=hexapod-forecast-restore-016', '--on-active=30m',
