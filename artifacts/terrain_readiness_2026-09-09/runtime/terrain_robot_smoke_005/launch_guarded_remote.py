...
PAUSE = BASE / 'forecast_pause_020'
UNIT = 'hexapod-terrain-robot-smoke-005-20260910.service'
...
''')
        ...
        subprocess.run(['systemd-run', '--user', '--unit=hexapod-forecast-restore-020', '--on-active=30m',
