...
SOURCE = BASE / 'terrain_robot_source_004'
OUTPUT = BASE / 'terrain_robot_smoke_004'
PAUSE = BASE / 'forecast_pause_017'
UNIT = 'hexapod-terrain-robot-smoke-004-20260909.service'
...
''')
        ...
        subprocess.run(['systemd-run', '--user', '--unit=hexapod-forecast-restore-017', '--on-active=30m',
