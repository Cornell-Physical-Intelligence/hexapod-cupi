...
SOURCE = BASE / 'terrain_robot_source_003'
OUTPUT = BASE / 'terrain_robot_smoke_003'
PAUSE = BASE / 'forecast_pause_015'
UNIT = 'hexapod-terrain-robot-smoke-003-20260909.service'
...
''')
        ...
        subprocess.run(['systemd-run', '--user', '--unit=hexapod-forecast-restore-015', '--on-active=30m',
