...
gates. It does not run PPO. No GPU job was launched while preparing these tools.
...
```sh
python3 /home/orionh/HEXAPOD_runs/mkii_profile_v1/tools/run_profile.py \
  ...
  --solver-multiplier 1 \
  --output /home/orionh/HEXAPOD_runs/mkii_profile_v1/profile_001
```
...
```sh
.venv/bin/python artifacts/mkii_fourbar_2026-09-06/profiling_tools_v1/test_profile_tools.py
```

Four tests pass: single-call/restoration for class methods, read-only native
method fallback, lazy-property preservation, and full real-hook coverage at both
16 and 32 substeps with exactly two traced controls. Separate CPU lifecycle
