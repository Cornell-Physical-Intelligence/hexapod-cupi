...
def synthetic_result(directory,n,one_sha=None,model_hash=None):
 ...
 write(directory/'session.json',{'captured_steps':8000,'all_rows_recorded':True,'steps':8000,'controls':1000,'reset_count':1,'failure':None,'substep_files':['substeps_000.npz']})
 ...
 state={'schema':'canonical_native_standing_v1','identity':identity,'status':'completed','inputs_unchanged':True,'errors':[],'native_error_events':[],
  'physical_admission':False,'physics_admitted':False,'training_allowed':False,'explicit_steps_completed':8000,'checks':{'CPU_PROTOCOL_FIXTURE_ONLY':True},'outputs':outputs}
