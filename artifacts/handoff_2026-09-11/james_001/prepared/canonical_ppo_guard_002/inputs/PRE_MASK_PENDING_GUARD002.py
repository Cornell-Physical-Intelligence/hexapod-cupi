...
PREVIOUS_UNIT='hexapod-canonical-native-standing32-004-20260910.service'
PREVIOUS_INVOCATION='b33d418438ea438ca0805eea68e70a43'
PREVIOUS_ROOT=BASE/'native_standing32_004'
PREVIOUS_PAUSE=BASE/'forecast_pause_016'
...
def verify_previous_owner():
    ...
    if pause.get('unit')!=PREVIOUS_UNIT or pause.get('output')!=str(PREVIOUS_ROOT)or set(restored.get('timers',[]))!=timers or restored.get('restored_unix')!=PREVIOUS_RESTORED_UNIX:raise RuntimeError('Previous exact pause016 restoration missing')
