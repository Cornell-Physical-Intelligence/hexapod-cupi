...
SOURCE=REPO/'tmp/canonical_ppo_integration_001'
class HostTests(unittest.TestCase):
    ...
    def test_exact_owner_and_source_inventories(self):
        ...
        h.verify_tree(REPO/'tmp/updated_native_standing_002','FREEZE_SHA256.json',h.STANDING_FREEZE)
    ...
    def test_real_contract_template_remains_disabled_without_process(self):
        ...
        a=self.args(Path('/unused'));a.standing_source=REPO/'tmp/updated_native_standing_002';a.bindings=SOURCE/'BINDINGS.json'
