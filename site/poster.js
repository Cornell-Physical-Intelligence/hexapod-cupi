...
try {
  ...
  $('#poster').innerHTML=`<div class="loading"><h1>The project data could not load.</h1><p>${esc(error.message)}</p><p><a href="STATUS.md">Read the current status on GitHub ↗</a></p></div>`;
}
